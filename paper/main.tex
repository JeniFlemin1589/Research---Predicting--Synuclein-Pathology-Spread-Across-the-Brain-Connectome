...
To support transparency and reproducibility, the complete PyTorch source code, temporal graph preprocessing scripts, and trained model weights associated with this study are publicly available at \url{https://github.com/JeniFlemin1589/Research---Predicting--Synuclein-Pathology-Spread-Across-the-Brain-Connectome}.
